...
export const RULES_SECTIONS = [
  ...
  },
  {
    ...
    summary:
      'हलन्त (खुट्टा काट्ने) र अजन्त (नकाट्ने) प्रयोगले अर्थ र मानक रूप दुवैमा प्रभाव पार्छ। धातु, केही क्रियारूप र मान्/वान्/वत् प्रत्यययुक्त शब्दमा हलन्त लाग्छ; धेरै सर्वनाम, अव्यय, सामान्य समापक क्रियारूप, र हलन्त उच्चारण हुने आगन्तुक शब्दहरू अजन्त लेखिन्छन्।',
    examples: [
      { wrong: 'महान', correct: 'महान्' },
      { wrong: 'जगत', correct: 'जगत्' },
      { wrong: 'कोट्', correct: 'कोट' },
    ],
    subRules: [
      'शब्दान्तमा हलन्त',
    ...
    referenceTargets: [
      ...
      },
      {
        ...
        label: 'अजन्त प्रयोग',
        status: 'implemented',
        summary: 'अजन्त रूपका मुख्य ढाँचाहरू छुट्टै नियमबाट सम्हालिएका छन्, ताकि हलन्त र अजन्त नियम मिश्रित नहोस्। PS शैक्षणिक व्याकरणका आगन्तुक उदाहरणहरू पनि अजन्त inventory बाट समेटिएका छन्।',
        examples: ['राम् -> राम', 'कोट् -> कोट', 'टेलिफोन् -> टेलिफोन'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    summary:
      'प्रज्ञा-प्रतिष्ठानको शुद्ध/अशुद्ध सूची, पदयोग/पदवियोग नियम, र पद-प्रयोगगत सुधार यस खण्डमा पर्छन्। शब्दकोशीय रूप, जोडेर/छुट्याएर लेखाइ, र प्रचलित अशुद्ध रूपहरूको मानकीकरण यही आधारमा गरिन्छ। समीक्षा गरिएका आधुनिक प्रचलित रूपहरू कडा मोडबाहिर सुझावका रूपमा मात्र देखिन सक्छन्।',
    examples: [
